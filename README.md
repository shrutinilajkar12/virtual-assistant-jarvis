...
```bash
git clone https://github.com/shrutinilajkar12/virtual-assistant-jarvis.git
...
| Temperature           | Retrieves Temperature           |
...
| Switch Window         | Switches Between Active Windows |
| Exit                  | Terminates Assistant            |
